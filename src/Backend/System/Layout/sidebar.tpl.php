    ...
    <div class="flex grow flex-col gap-y-5 overflow-y-auto px-6 pb-4 bg-gradient-to-br from-gray-800 to-gray-900">
      <div class="flex h-16 shrink-0 items-center font-semibold text-gray-400">
        Backend
      </div>
          ...
          <li>
            <ul role="list" class="-mx-2 space-y-1">
              <li>
                ...
                <a href="#" class="group flex gap-x-3 rounded-md bg-gray-700 p-2 text-sm font-semibold leading-6 text-white">
              ...
              <li>
                <a href="#" class="group flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-gray-400 hover:bg-gray-700 hover:text-white">
                  <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
